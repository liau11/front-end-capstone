    ...
    <Card style={{ width: '18rem', marginTop: '40px', marginBottom: '40px' }} className='border p-4' id='card'>
      ...
      <Card.Body>
        ...
        <Card.Footer className='d-flex justify-content-center align-items-center'>
          <OverlayTrigger placement='top' overlay={<Tooltip id={'yelp-msg'}>Open Yelp</Tooltip>}>
            <Button className="btn-sm" variant="outline-danger" onClick={openYelpInNewTab}>
              <Icon icon="bi:yelp" color="red" width="18" height="18" />
            </Button>
          </OverlayTrigger>
          <OverlayTrigger placement='top' overlay={<Tooltip id={'google-maps-msg'}>Open Google Maps</Tooltip>}>
            <Button className="btn-sm" variant="info" onClick={openGoogleMaps}>
              <Icon icon="bi:map" color="white" width="18" height="18" />
            </Button>
          </OverlayTrigger>
          <OverlayTrigger placement='top' overlay={<Tooltip id={'delete-msg'}>Delete</Tooltip>}>
          ...
          <OverlayTrigger placement='top' overlay={<Tooltip id={'delete-msg'}>Delete & Move to 'My Recommendations'</Tooltip>}>

...
const HomePage = ({ handleAddToList, users, currentUser, recommendationsData, updateUserAdd, getFriendsRecommendations, cityCenter }) => {
    return (
        <section>
            <h1>Welcome to the Home Page!</h1>
            < Map cityCenter={cityCenter} recommendationsData={recommendationsData} ></Map >
            <RecommendationsResultsList handleAddToList={handleAddToList} currentUser={currentUser} recommendationsData={recommendationsData} updateUserAdd={updateUserAdd} />
